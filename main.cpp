...
//	SDL_Surface *image_sur = SDL_ConvertSurfaceFormat(background, SDL_PIXELFORMAT_ABGR8888 , 0);
//
//
//	GLuint texture;
//	glGenTextures(1, &texture);
//	glBindTexture(GL_TEXTURE_2D, texture);
//	gluBuild2DMipmaps(GL_TEXTURE_2D, 4, image_sur->w, image_sur->h, GL_RGBA, GL_UNSIGNED_BYTE, image_sur->pixels);
